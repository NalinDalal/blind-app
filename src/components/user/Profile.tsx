        ...
        <>
            <section className="flex items-center space-x-4 p-6 bg-white dark:bg-neutral-800 text-gray-900 dark:text-white">
                <motion.div variants={itemVariants} initial="hidden" animate="visible" transition={{ delay: 0.1 }}>
                    <Avatar seed={userName} size={"lg"} className="border-2 border-orange-500" />
                </motion.div>
                <div className="flex flex-col justify-center">
                    <motion.h1 variants={itemVariants} initial="hidden" animate="visible" transition={{ delay: 0.2 }} className="text-2xl font-bold">
                        {userName}
                    </motion.h1>
                    <motion.p variants={itemVariants} initial="hidden" animate="visible" transition={{ delay: 0.3 }} className="text-neutral-600 dark:text-neutral-400 text-base">
                        {userEmail}
                    </motion.p>
                    <motion.p variants={itemVariants} initial="hidden" animate="visible" transition={{ delay: 0.4 }} className="text-neutral-500 dark:text-neutral-300 text-sm mt-1">

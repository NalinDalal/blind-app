...
/**
 * Render the Home page containing the post feed and a notifier for new posts.
 *
 * Shows a "New posts available" button when newer posts are detected; activating the button refreshes the feed and scrolls to the top so the user can see the latest posts.
 *
